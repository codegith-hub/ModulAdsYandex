...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AdsLibraryAccessors laccForAdsLibraryAccessors = new AdsLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>masterads</b> with <b>com.github.codegith-hub:MasterAds</b> coordinates and
     * with version reference <b>masterads</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getMasterads() {
        return create("masterads");
    }
    ...
    /**
     * Group of libraries at <b>ads</b>
     */
    public AdsLibraryAccessors getAds() {
        return laccForAdsLibraryAccessors;
    }
    ...
    public static class AdsLibraryAccessors extends SubDependencyFactory {

        public AdsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.pangle.global:ads-sdk</b> coordinates and
         * with version reference <b>adsSdk</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSdk() {
            return create("ads.sdk");
        }
    ...
    public static class LifecycleLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>lifecycleProcess</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>adsSdk</b> with value <b>6.1.0.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAdsSdk() { return getVersion("adsSdk"); }
        ...
        /**
         * Version alias <b>lifecycleProcess</b> with value <b>2.8.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>masterads</b> with value <b>1.0.11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMasterads() { return getVersion("masterads"); }
        ...
        /**
         * Version alias <b>playServicesAdsIdentifier</b> with value <b>18.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
